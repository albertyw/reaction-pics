...
func Run(logger *zap.Logger) {
	...
	mux.Handle("/", generator.newHandler(indexHandler))
	mux.Handle("/favicon.ico", generator.newHandler(faviconHandler))
	mux.Handle("/robots.txt", generator.newHandler(robotsTxtHandler))
	mux.Handle("/.well-known/security.txt", generator.newHandler(securityHandler))
	mux.Handle("/search", generator.newHandler(searchHandler))
	mux.Handle("/postdata/", generator.newHandler(postDataHandler))
	mux.Handle("/post/", generator.newHandler(postHandler))
	mux.Handle("/stats.json", generator.newHandler(statsHandler))
	mux.Handle("/sitemap.xml", generator.newHandler(sitemapHandler))
	mux.Handle("/static/", generator.newHandler(staticHandler))
